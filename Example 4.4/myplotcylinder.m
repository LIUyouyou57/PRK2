...
fill3(X(1,:),Y(1,:),Z(1,:),[1 0.8549 0.72549],'EdgeColor','none','FaceAlpha',1) %底面
hold on
fill3(X(2,:),Y(2,:),Z(2,:),[1 0.8549 0.72549],'EdgeColor','none','FaceAlpha',1) %顶面
hold on
surf(X,Y,Z,'facecolor',[0.52941 0.80784 0.98039],'edgecolor','none','FaceAlpha',1)    %圆柱表面
