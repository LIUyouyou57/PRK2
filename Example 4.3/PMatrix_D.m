...
% g_back = [g{6,1},...;
[N, ~] = size(g{1});
b_c1 = zeros(N, N, N);  b_c2 = zeros(N, N, N);  b_c3 = zeros(N, N, N);  
b_c1(:,1,:) = g{1,1};  b_c1(:,:,end) = b_c1(:,:,end)+g{4,1};  b_c1(:,end,:) = b_c1(:,end,:)+g{2,1};  b_c1(:,:,1) = b_c1(:,:,1)+g{3,1};  b_c1(1,:,:) = b_c1(1,:,:)+g{6,1};  b_c1(end,:,:) = b_c1(end,:,:)+g{5,1};
b_c2(:,1,:) = g{1,2};  b_c2(:,:,end) = b_c2(:,:,end)+g{4,2};  b_c2(:,end,:) = b_c2(:,end,:)+g{2,2};  b_c2(:,:,1) = b_c2(:,:,1)+g{3,2};  b_c2(1,:,:) = b_c2(1,:,:)+g{6,2};  b_c2(end,:,:) = b_c2(end,:,:)+g{5,2};
b_c3(:,1,:) = g{1,3};  b_c3(:,:,end) = b_c3(:,:,end)+g{4,3};  b_c3(:,end,:) = b_c3(:,end,:)+g{2,3};  b_c3(:,:,1) = b_c3(:,:,1)+g{3,3};  b_c3(1,:,:) = b_c3(1,:,:)+g{6,3};  b_c3(end,:,:) = b_c3(end,:,:)+g{5,3};
